        ...
        <div className="max-w-8xl mx-auto bg-white p-8 rounded-2xl shadow-md">
            ...
            <div className="space-y-4">
                {hospitaisFiltrados.map((hospital) => (
                    <div key={hospital.id} onClick={() => navigate(`/hospitais/${hospital.id}`)} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition cursor-pointer">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                <button 
                                    onClick={(e) => {e.stopPropagation(); editarHospital(hospital);}} 
